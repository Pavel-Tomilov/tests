// src/pages/PlayListsPage/__tests__/PlayListsPage.test.tsx
...
jest.mock("../../../data/playlists", () => ({
  PLAYLISTS: require("../../../__mocks__/playlists.mock").PLAYLISTS,
}));
...
describe("PlayListsPage", () => {
  ...
  it("фильтрует плейлисты по жанру 'Jazz'", () => {
    ...
    playlistLinks.forEach((link) => {
      const playlist = require("../../../__mocks__/playlists.mock").PLAYLISTS.find(
